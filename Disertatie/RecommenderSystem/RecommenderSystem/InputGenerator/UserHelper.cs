...
namespace RecommenderSystem.InputGenerator
{
    public static class UserHelper
    {
        ...
        public static int SelectRandomAge(Random r)
        {
            int age = r.Next(7, 85);
            return age;
        }

        public static string SelectRandomGender(Random r)
        {
        ...
        public static string SelectOccupationBasedOnAge(int age, Random rand)
        {
            ...
            string occup = occupationsToSelect[index];

            return occup;
        }

        public static Dictionary<string, string> AddMoviesForUsers(Dictionary<string, User> users, Dictionary<string, MovieResult> movies,
            Random rand)
        {
