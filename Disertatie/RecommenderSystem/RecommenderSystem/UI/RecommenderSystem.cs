...
using RecommenderSystem.Algorithms.kNearestNeighbours;
...
{
    public partial class RecommenderSystem : Form
    {
        #region Constructors
        ...
        private void RecommenderSystem_Load(object sender, EventArgs e)
        {
        ...
        private void RecommenderSystem_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (forms.Count > 0)
                {
                    ...
                    Form smfGeneratorToolForm = forms["RecommenderSystem"];
        ...
        private void RecommenderSystem_Activated(object sender, EventArgs e)
        {
            FormCollection forms = Application.OpenForms;
        ...
        private void _startAnalysisButton_Click(object sender, EventArgs e)
        {
            List<IAlgorithm> algorithms = new List<IAlgorithm>();

            if (_knnCheckbox.Checked)
            {
                algorithms.Add(new kNN());
            }

            Thread algorithmExecutor = new Thread(() => AlgoritmExecutor.ExecuteAlgorithms(algorithms));
            algorithmExecutor.IsBackground = true;
            algorithmExecutor.Start();
        }

        private void _viewStatisticsButton_Click(object sender, EventArgs e)
        {
            Statistics statisticsDialog = new Statistics();
            statisticsDialog.ShowDialog();
        }

        #region Browse files handlers
        ...
        private void _chooseMoviesPathButton_Click(object sender, EventArgs e)
        {
            _moviesTextBox.Text = SelectFileDialog(" Movies file");
        }

        private void _chooseUsersPathButton_Click(object sender, EventArgs e)
        {
            _usersTextbox.Text = SelectFileDialog(" Users file");
        }

        private void _chooseUserRatingsPathButton_Click(object sender, EventArgs e)
        {
            _userRatingsTextbox.Text = SelectFileDialog(" User Ratings file");
        }
        #endregion
