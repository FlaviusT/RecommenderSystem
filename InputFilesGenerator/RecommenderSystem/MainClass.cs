    ...
    static class MainClass
    {
        ...
        static void Main()
        {
            string titleBasics = "", directorsBasics = "", ratingsBasics = "",
                ...
                moviesFullCleaned = "", usersOutput = "", usersRatingsOutput = "", castBasics = "", castShort = "";
            ...
            InitializeVariables(ref titleBasics, ref directorsBasics, ref ratingsBasics, ref namesBasics,
              ref titleShort, ref directorsShort, ref ratingsShort, ref namesShort, ref moviesFullDirty,
               ref moviesFullCleaned, ref usersOutput, ref usersRatingsOutput, ref castBasics,
               ref castShort, ref userCounter);

            Parsers.WriteMoviesShort(titleBasics, titleShort);

            Parsers.WriteDirectorsShort(titleShort, directorsBasics, directorsShort);

            Parsers.WriteCastShort(titleShort, castBasics, castShort);

            Parsers.WriteNamesShort(directorsShort, castShort, namesBasics, namesShort);

            Parsers.WriteRatingsShort(titleShort, ratingsBasics, ratingsShort);

            Parsers.WriteMoviesResultsFile(titleShort, ratingsShort, namesShort, directorsShort, castShort, moviesFullDirty);
        ...
        private static void InitializeVariables(ref string titleBasics, ref string directorsBasics, ref string ratingsBasics,
           ...
           ref string castBasics, ref string castShortOutput, ref int userCounter)
        {
            ...
            castBasics = @"C:\Users\uidj1061\Desktop\New folder\castbasics.tsv";
            ...
            castShortOutput = @"C:\Users\uidj1061\Desktop\New folder\shorts\castShort.tsv";

            moviesFullDirty = @"C:\Users\uidj1061\Desktop\New folder\moviesFull.tsv";

            moviesFullCleaned = @"C:\Users\uidj1061\Desktop\dsa\movies.csv";
